...
public class ArtikalController {
	...
	public String getAll() {
		List<Artikal> artikli = new ArrayList<Artikal>(dostava.getArtikli().values());
		...
		for(int i = 0; i < artikli.size(); i++) {
			Artikal tempArt = artikli.get(i);
			response.append(
					"				<tr>\r\n"
					+ "					<td>" + (i +1) + "</td>\r\n"
					+ "					<td>" + tempArt.getNaziv() + "</td>\r\n"
					+ "					<td>" + tempArt.getOpis() + "</td>\r\n"
					+ "					<td>" + tempArt.getCena() + "RSD </td>\r\n"
				);
		}
